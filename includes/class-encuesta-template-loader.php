...
if ( ! class_exists( 'Encuesta_Template_Loader' ) )  {

	class Encuesta_Template_Loader {

		protected $filter_prefix = 'encuesta';
		protected $theme_template_directory = 'encuesta';
		protected $plugin_directory = ENCUESTA_PLUGIN_DIR;
