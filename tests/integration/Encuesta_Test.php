<?php
class Encuesta_Test extends \Codeception\TestCase\WPAjaxTestCase {
  ...
  public function test_instance() {
	...
	public function test_constants() {
		$path = str_replace( 'tests/integration/', '', plugin_dir_url( __FILE__ ) );
		$this->assertSame( ENCUESTA_PLUGIN_URL, $path );

		$path = str_replace( 'tests/integration/', '', plugin_dir_path( __FILE__ ) );
